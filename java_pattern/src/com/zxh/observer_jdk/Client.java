...
public class Client {
	...
	public static void main(String[] args) {
		...
		System.out.println("team one 获得线人信息："+p1.getInformantLocation());
		System.out.println("team two  获得线人信息："+p2.getInformantLocation());
		System.out.println("team three 获得线人信息："+p3.getInformantLocation());
		System.out.println("########## #############");
